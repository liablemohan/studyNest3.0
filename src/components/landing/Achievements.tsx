    ...
    return (
        <section className="section bg-white relative overflow-hidden">
            ...
            <div className="container mx-auto relative z-10">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                    {stats.map((stat, index) => (
                        <motion.div
                            ...
                            className="bg-gradient-to-br from-beige-50 to-white p-6 rounded-2xl
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    {achievements.map((achievement, index) => (
                        <motion.div
                            ...
                            className="flex gap-5 p-6 bg-gradient-to-r from-navy-700 to-navy-800
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-beige-100 rounded-full">
